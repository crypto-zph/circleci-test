<template>
    <div>
                ...
                <div>
                    <span>
                        ...
                        <span style="font-weight: 500; letter-spacing: 1px"> 
                            {{ 
                                currentBalance | balanceConversion(decimal_places, res.conversion.rates[currency_abbreviation])
                            }}
                        </span>
        ...
        <div class="col-md-4 col-12 q-mt-lg">
            <div class="q-py-md text-center q-px-lg text-bold text-grey-9 wallet_titleOnMobile" style="font-size: 17px">
                ALL WALLETS
            </div>
            <div class="q-mx-md wallet_titleOnMobile">
                <q-separator />
            </div>
            <div class="q-mx-xs">
                <div v-for="(wallet, index) in wallet_arr" :key="index" class="wallet_titleOnMobile">
                    ...
                    >
                        <div class="col-6"> 
                            <span v-if="wallet.is_receiving == true">receiving {{ wallet.receiving_amount }}</span>
                            {{ wallet.currency_abbreviation }}
                        </div>
...
export default
{
    ...
    methods:
    {
        ...
        //     });   
        //     this.socket.on('update_crypto', async (data) => 
        //     {
        //         console.log(data)
        //         if(this.$static_user_info._id == data.user_id)
        //         {
        //             this.wallet_arr.find(x => x.currency_abbreviation === data.currency_abbreviation).balance = data.balance;
        //             console.log('UPDATED BY SOCKET', this.wallet_arr)
        //         }
        //     });
        // },
